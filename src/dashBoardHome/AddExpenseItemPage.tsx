        ...
        if(!Result_WRITE_EXTERNAL_STORAGE){
            ...
            try {
                const granted = await PermissionsAndroid.request(
                    ...
                    {
                        title: 'Cool Photo App_tsx_old Write_EXTERNAL_STORAGE Permission',
                        message:
                            'Cool Photo App_tsx_old needs access to your Storage ' +
    ...
    async function requestCameraPermission() {
        try {
            const granted = await PermissionsAndroid.request(
                ...
                {
                    title: 'Cool Photo App_tsx_old Camera Permission',
                    message:
                        'Cool Photo App_tsx_old needs access to your camera ' +
