...
import DashBoardHome from './src/dashBoardHome/DashBoardHome';
import { createStackNavigator } from '@react-navigation/stack';
import SplashScreen from './src/identity/SplashScreen';
import Login from "./src/identity/LoginSignUP/Login";
import LoginSignUP from "./src/identity/LoginSignUP/LoginSignUP";
import AddExpenseItemPage from "./src/dashBoardHome/AddExpenseItemPage";
...
const App: React.FC<Props> = (props) => {
    // const App_tsx_old: React.FC<Props> = () => {

    // export default function App_tsx_old() {
    return (
        <NavigationContainer>
